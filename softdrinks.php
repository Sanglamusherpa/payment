...
<body>
  ...
  <h1 style="color:brown;text-align:center;padding:20px">Soft Drinks</h1>
...
<!--yo wala try ho-->
	 <div>
     <img src="images\mirinda.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Mirinda</h1>
     <div class="product-card-price">

									
										</div>
										<p style="color:brown;text-align:center;font-weight:bolder">Ksh.2,500</p>
										...
										<div class="card-btn">
											<a href="cartpage.html" class="btn-primary add-to-cart">Add To Cart</a>
										</div>     
</div><br>
	   <div>
     <img src="images\coca cola.webp" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Coca Cola</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\7 UP.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">7 UP</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\eno.webp" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Eno</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\LITCHI.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Litchi Juice</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\7up.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:70px">7up</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\charged.webp" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Charged</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\nimbu paani.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Nimbu Paani</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\sprite.jpg" alt="drink5" style="max-width:70%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Sprite</h1>
     <div class="product-card-price">
...
<div>
     <img src="images\LITCHI.jpg" alt="drink5" style="max-width:100%;height:auto;">
     <h1 style="color:black;text-align:center;font-size:20px;padding-top:10px">Litchi</h1>
     <div class="product-card-price">
