...
<html lang="en">
<?php
$payment_id = "1234567890"; // Set a payment ID
$txn_id = "TXN123456789"; // Set a transaction ID
$payment_gross = "$50.00"; // Set the paid amount
$payment_status = "Completed"; // Set the payment status

// Product information (replace with your product data)
$productRow = array(
    'name' => '7 UP',
    'price' => '$50.00' // Set the product price
);
?>
